...
\usepackage[colorlinks=false, bookmarks=false, urlcolor=blue]{hyperref}
...
% \textcolor{blue}{La siguiente imagen describe la arquitectura del sistema:}
% \begin{figure}[htb]
\begin{center} 
%\includegraphics[height=5.3in]{imagenes/Plan2.png}
...
% \textbf{Autor (es)}: Annelissie Arr\'azola M.\\
