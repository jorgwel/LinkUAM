...
% \textcolor{black}{Una descripci\'on m\'as a detalle de esta licencia se encuentra en esta liga: \\\href{http://creativecommons.org/licenses/by-nc-sa/2.5/mx/}{http://creativecommons.org/licenses/by-nc-sa/2.5/mx/}}ç
...
\begin{itemize}
%  \item \textit{JavaServer Pages}\footnote{JavaServer Pages (JSP) es una tecnolog\'ia Java que permite generar contenido din\'amico para web, en forma de documentos HTML, XML o de otro tipo.}\cite{jsp}ç
...
%  \item \textit{JavaServer Faces}\footnote{JavaServer Faces (JSF) es una tecnolog\'ia y framework para aplicaciones Java basadas en web que simplifica el desarrollo de interfaces de usuario en aplicaciones Java}\cite{jsf}
...
\bibitem{rae} \textcolor{black}{Real Academia Espa\~nola, \href{http://www.rae.es}{http://www.rae.es}}

\bibitem{papeluniversidad} \textcolor{black}{Instituto Tecnol\'ogico Aut\'onomo de M\'exico (ITAM), ``\textit{El papel de las universidades}'' \href{http://biblioteca.itam.mx/estudios/estudio/letras39-40/texto10/sec\_2.html}{http://biblioteca.itam.mx} } 
...
\bibitem{redmexicana} Red mexicana de emprendedores, \href{http://www.angelesinversionistas.com.mx}{http://www.angelesinversionistas.com.mx}

\bibitem{angel} \'Angel Ventures M\'exico, \href{http://www.angelesinversionistas.com.mx}{http://www.angelesinversionistas.com.mx}


\bibitem{itam} Emprendimiento, Tecnol\'ogico de Monterrey, \href{http://www.itesm.edu/wps/wcm/connect/ITESM/Tecnologico+de+Monterrey/Emprendimiento/#2}{http://www.itesm.edu}


\bibitem{desarrollo} \textcolor{black}{Jairo Edgardo Arias Dur\'an, \textit{Resumen del art\'iculo ``Desarrollo de la Cultura Emprendedora}'' \href{http://www.emplenet.org.co/roce/documentos/desarrollo\%20de\%20la\%20cultura\%20emprendedora.pdf}{http://www.emplenet.org.co}}

\bibitem{emprendedurismo} \textcolor{black}{Annelissie Arr\'azola M., ``\textit{EMPRENDEDURISMO}'' \href{http://produccionintelectual.nur.edu/archivos/emprendedurismo.pdf}{http://produccionintelectual.nur.edu}}

% \bibitem{ingenioi} \textcolor{black}{Pilar P\'erez Hern\'andez, Rub\'en Oliver Espinoza, Humberto Merritt Tapia, Alejandro M\'arquez, ``\textit{El emprendedor en M\'exico: ingenio vs innovaci\'on}'' \href{http://www.oei.es/memoriasctsi/mesa12/m12p25.pdf}{http://www.oei.es} }
...
\bibitem{w3c} World Wide Web Consortium, \href{http://www.w3.org/}{http://www.w3.org/}

\bibitem{oracle} Bruce Eckel, \textit{Piensa en Java}, 3 edici\'on, M\'exico, Prentice-Hall, 2002


\bibitem{creativecommons} Creative Commons License, \href{http://creativecommons.org/licenses/by-nc-sa/2.5/mx/}{http://creativecommons.org/licenses/by-nc-sa/2.5/mx/}


\bibitem{jsp} Simon Brown, \textit{Pro JSP} ,4 edici\'on, Estados Unidos, Apress, 2006

\bibitem{jsf} David Geary, \textit{Core JavaServer Faces}, 3 edici\'on, Estados Unidos, Prentice-Hall, 2010

\bibitem{postgre} Korry Douglas and Susan Douglas, \textit{PostgreSQL}, 2 edici\'on, Developers Library, 2005


\bibitem{debian} Martin F. Krafft, \textit{The Debian System: Concepts and Techniques}, 1 edici\'on, 2005
